...
numberofbubbles1 =  pi * (D/2 *1e3)^2 * len1 * 300;
...
numberofbubbles2 =  pi * (D/2 *1e3)^2 * len2 * 300;
...
numberofbubbles3 =  pi * (D/2 *1e3)^2 * len3 * 300;
...
data = sum(datatemp,4);
save('cocentrichalfcircularvessels.mat','data','-v7.3');