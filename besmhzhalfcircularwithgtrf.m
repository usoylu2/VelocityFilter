...
groundtruth1 = zeros(Nz,Nx,duration);
groundtruth2 = zeros(Nz,Nx,duration);
groundtruth3 = zeros(Nz,Nx,duration);
...
for j=1:numberofbubbles1
    groundtruth1(ceil(positions1(j,2)/enddepth * Nz),ceil((positions1(j,1)+abs(x(1)-x(end))/2) /abs(x(1)-x(end)) * Nx),1)= groundtruth1(ceil(positions1(j,2)/enddepth* Nz ),ceil((positions1(j,1)+abs(x(1)-x(end))/2) /abs(x(1)-x(end)) * Nx),1)+1;
end
for j=1:numberofbubbles2
    groundtruth2(ceil(positions2(j,2)/enddepth * Nz),ceil((positions2(j,1)+abs(x(1)-x(end))/2) /abs(x(1)-x(end)) * Nx),1)= groundtruth2(ceil(positions2(j,2)/enddepth * Nz ),ceil((positions2(j,1)+abs(x(1)-x(end))/2) /abs(x(1)-x(end)) * Nx),1)+1;
end
for j=1:numberofbubbles3
    groundtruth3(ceil(positions3(j,2)/enddepth * Nz),ceil((positions3(j,1)+abs(x(1)-x(end))/2) /abs(x(1)-x(end)) * Nx),1)= groundtruth3(ceil(positions3(j,2)/enddepth * Nz ),ceil((positions3(j,1)+abs(x(1)-x(end))/2) /abs(x(1)-x(end)) * Nx),1)+1;
end
...
numberofbubbles = temp(1);
        ...
        if vessels ==1
           ...
           if number_of_frames < duration
               for j=1:numberofbubbles
                   groundtruth1(ceil(positions(j,2)/enddepth * Nz),ceil((positions(j,1)+abs(x(1)-x(end))/2) /abs(x(1)-x(end))* Nx),number_of_frames+1)= groundtruth1(ceil(positions(j,2)/enddepth* Nz ),ceil((positions(j,1)+abs(x(1)-x(end))/2) /abs(x(1)-x(end)) * Nx),number_of_frames+1)+1;
               end
           end
        elseif vessels ==2
           ...
           if number_of_frames < duration
               for j=1:numberofbubbles
                   groundtruth2(ceil(positions(j,2)/enddepth * Nz),ceil((positions(j,1)+abs(x(1)-x(end))/2) /abs(x(1)-x(end))* Nx),number_of_frames+1)= groundtruth2(ceil(positions(j,2)/enddepth* Nz ),ceil((positions(j,1)+abs(x(1)-x(end))/2) /abs(x(1)-x(end)) * Nx),number_of_frames+1)+1;
               end
           end
        elseif vessels ==3
           ...
           if number_of_frames < duration
               for j=1:numberofbubbles
                   groundtruth3(ceil(positions(j,2)/enddepth * Nz),ceil((positions(j,1)+abs(x(1)-x(end))/2) /abs(x(1)-x(end))* Nx),number_of_frames+1)= groundtruth3(ceil(positions(j,2)/enddepth* Nz ),ceil((positions(j,1)+abs(x(1)-x(end))/2) /abs(x(1)-x(end)) * Nx),number_of_frames+1)+1;
               end
           end
        end       
end
...
data = sum(datatemp,4);
save('halfcircle5MHzoppositerfwithgt_150Hz','data','-v7.3');
save('halfcircle5MHzoppositerfgt1_150Hz','groundtruth1','-v7.3');
save('halfcircle5MHzoppositerfgt2_150Hz','groundtruth2','-v7.3');
save('halfcircle5MHzoppositerfgt3_150Hz','groundtruth3','-v7.3');