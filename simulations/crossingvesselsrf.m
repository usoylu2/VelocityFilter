...
D = 0.3e-3; %diameter of the vessels
v2 = 10e-3;
slope1 = 0;
slope2 = -0.2;
...
numberofbubbles =  pi * (D/2 *1e3)^2 * len * density/3;
...
numberofbubbles =  pi * (D/2 *1e3)^2 * len * density /3; %initilaze with more bubbles
numberofbubbles = ceil(numberofbubbles);
...
data = sum(datatemp,4);
save('intersectingvessels5MHZrfwithgt100Hz.mat','data','-v7.3');
save('intersectingvessels5MHZrfgt1_100Hz.mat','groundtruth1','-v7.3');
save('intersectingvessels5MHZrfgt2_100Hz.mat','groundtruth2','-v7.3');
