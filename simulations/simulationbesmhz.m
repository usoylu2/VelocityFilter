...
numberofbubbles = 2* pi * (D/2 *1e3)^2 * len * density/3;
...
save('twovesseloppositedirection5MHz.mat','data','-v7.3');
...
data = sum(datatemp,4);
save('intersectingvessels5MHZ.mat','data','-v7.3');
